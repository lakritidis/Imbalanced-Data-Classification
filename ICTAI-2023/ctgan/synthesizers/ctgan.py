...
class CTGAN(BaseSynthesizer):
    ...
    def __init__(self, torch_state, embedding_dim=128, generator_dim=(256, 256), discriminator_dim=(256, 256),
                 generator_lr=2e-4, generator_decay=1e-6, discriminator_lr=2e-4,
                 discriminator_decay=1e-6, batch_size=500, discriminator_steps=1, sampling_strategy=1.0,
    ...
    @random_state
    def fit_gan(self, train_data, discrete_columns=(), epochs=None):
    ...
    def fit_resample(self, x, y):
        ...
        for cls in range(num_classes):
            if cls != majority_class:
                ...
                self.fit_gan(train_minority_samples)
                ...
                synthetic_samples = self.sample(no_samples)
...
class SB_GAN(BaseSynthesizer):
    ...
    def __init__(self, torch_state, embedding_dim=128, generator_dim=(256, 256), discriminator_dim=(256, 256),
                 generator_lr=2e-4, generator_decay=1e-6, discriminator_lr=2e-4,
                 discriminator_decay=1e-6, batch_size=500, discriminator_steps=1, sampling_strategy=1.0,
                 log_frequency=True, verbose=False, epochs=300, pac=10, cuda=True, radius=1.0):

        super(SB_GAN, self).__init__()
